...
/* ------------------------ Incluir alguns DOMINIOS para testes ----------------------- */
   ...
   VALUES
       (01, 'USUARIO_STATUS'        , 0, 'CADASTRADO' , 'Cadastrado'                                        , 'root')
      ,(02, 'USUARIO_STATUS'        , 1, 'ATIVO'      , 'Ativo'                                             , 'root')
      ,(03, 'USUARIO_STATUS'        , 2, 'INATIVO'    , 'Inativo'                                           , 'root')
      ,(04, 'USUARIO_STATUS'        , 3, 'SUSPENSO'   , 'Suspenso'                                          , 'root')
      ,(05, 'USUARIO_STATUS'        , 4, 'BLOQUEADO'  , 'Bloqueado'                                         , 'root')
      ,(06, 'CLIENTE_STATUS'        , 0, 'CADASTRADO' , 'Cadastrado'                                        , 'root')
      ,(07, 'CLIENTE_STATUS'        , 1, 'ATIVO'      , 'Ativo'                                             , 'root')
      ,(08, 'CLIENTE_STATUS'        , 2, 'PGTO_PEND'  , 'Pagamento Pendente'                                , 'root')
      ,(09, 'CLIENTE_STATUS'        , 3, 'PGTO_ATRA'  , 'Pagamento Atrasado'                                , 'root')
      ,(10, 'CLIENTE_STATUS'        , 4, 'LIMI_PGTO'  , 'Acesso Limitado por falta de Pagamento'            , 'root')
      ,(11, 'CLIENTE_STATUS'        , 5, 'SUSP_PGTO'  , 'Suspenso por falta de Pagamento'                   , 'root')

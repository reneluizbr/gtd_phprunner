...
require_once("include/tb_categorias_x_atividades_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tb_categorias_x_atividades" );

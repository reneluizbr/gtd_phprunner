...
require_once("include/proc_limpar_tarefas_de_lista_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "proc_limpar_tarefas_de_lista" );

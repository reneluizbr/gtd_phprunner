...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("tb_atividade" == $this->chrt_array['tables'][0])
			return true;
		if("tb_clientes" == $this->chrt_array['tables'][0])
			return true;
		if("tb_clientes_planos" == $this->chrt_array['tables'][0])
			return true;
		if("tb_dominios" == $this->chrt_array['tables'][0])
			return true;
		if("tb_lista_atividades" == $this->chrt_array['tables'][0])
			return true;
		if("tb_planos" == $this->chrt_array['tables'][0])
			return true;
		if("tb_planos_valores" == $this->chrt_array['tables'][0])
			return true;
		if("tb_status_atividades" == $this->chrt_array['tables'][0])
			return true;
		if("tb_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("seguranca_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("tb_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("tb_usuarios" == $this->chrt_array['tables'][0])
			return true;
		if("log_audit" == $this->chrt_array['tables'][0])
			return true;
		if("tb_atividade" == $this->chrt_array['tables'][0])
			return true;
		if("proc_limpar_tarefas_de_lista" == $this->chrt_array['tables'][0])
			return true;

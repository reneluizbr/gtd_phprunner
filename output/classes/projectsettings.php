...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("tb_usuarios", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tb_atividade" ] = array( "url" => "tb_atividade", "type" => 0 );
	$projectEntitiesReverse[ "tb_atividade" ] = "tb_atividade";
	$projectEntities[ "tb_clientes" ] = array( "url" => "tb_clientes", "type" => 0 );
	$projectEntitiesReverse[ "tb_clientes" ] = "tb_clientes";
	$projectEntities[ "tb_clientes_planos" ] = array( "url" => "tb_clientes_planos", "type" => 0 );
	$projectEntitiesReverse[ "tb_clientes_planos" ] = "tb_clientes_planos";
	$projectEntities[ "tb_dominios" ] = array( "url" => "tb_dominios", "type" => 0 );
	$projectEntitiesReverse[ "tb_dominios" ] = "tb_dominios";
	$projectEntities[ "tb_lista_atividades" ] = array( "url" => "tb_lista_atividades", "type" => 0 );
	$projectEntitiesReverse[ "tb_lista_atividades" ] = "tb_lista_atividades";
	$projectEntities[ "tb_planos" ] = array( "url" => "tb_planos", "type" => 0 );
	$projectEntitiesReverse[ "tb_planos" ] = "tb_planos";
	$projectEntities[ "tb_planos_valores" ] = array( "url" => "tb_planos_valores", "type" => 0 );
	$projectEntitiesReverse[ "tb_planos_valores" ] = "tb_planos_valores";
	$projectEntities[ "tb_status_atividades" ] = array( "url" => "tb_status_atividades", "type" => 0 );
	$projectEntitiesReverse[ "tb_status_atividades" ] = "tb_status_atividades";
	$projectEntities[ "tb_usuarios" ] = array( "url" => "tb_usuarios", "type" => 0 );
	$projectEntitiesReverse[ "tb_usuarios" ] = "tb_usuarios";

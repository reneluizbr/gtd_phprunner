...
require_once(getabspath('classes/searchclause_base.##@ext##'));
...
class SearchClause extends SearchClauseBase
{
	...
	*/
	function getFilterWhereByType($filterType, $fName, $fValue, $sValue, $parentValues, $connection)
	{
		...
		{
			include_once getabspath("classes/controls/FilterControl.##@ext##");
			include_once getabspath("classes/controls/FilterIntervalSlider.##@ext##");
			include_once getabspath("classes/controls/FilterIntervalDateSlider.##@ext##");
		}
		...
		switch($filterType)
		{
			case 'interval':
				...
				include_once getabspath("classes/controls/FilterControl.##@ext##");
				include_once getabspath("classes/controls/FilterIntervalList.##@ext##");
...
//				return $fullFieldName."=".$this->cipherer->MakeDBValue($fName, $fValue, "", true);
			...
			case 'checked':
				...
				include_once getabspath("classes/controls/Control.##@ext##");
				include_once getabspath("classes/controls/CheckboxField.##@ext##");
			...
			case 'slider':
				...
				if($timeField)
				{
					include_once getabspath("classes/controls/FilterIntervalTimeSlider.##@ext##");

...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "gtd_20200511_db3" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "tb_categorias", "varname" => "gtd_20200511_db3__tb_categorias", "altvarname" => "tb_categorias", "connId" => "gtd_20200511_db3", "schema" => "", "connName" => "gtd_20200511.db3");
			$dalTables[$conn->connId][] = array("name" => "tb_categorias_x_atividades", "varname" => "gtd_20200511_db3__tb_categorias_x_atividades", "altvarname" => "tb_categorias_x_atividades", "connId" => "gtd_20200511_db3", "schema" => "", "connName" => "gtd_20200511.db3");

...
$nonAdminTablesArr[] = "tb_atividade";
$nonAdminTablesArr[] = "tb_clientes";
$nonAdminTablesArr[] = "tb_clientes_planos";
$nonAdminTablesArr[] = "tb_dominios";
$nonAdminTablesArr[] = "tb_lista_atividades";
$nonAdminTablesArr[] = "tb_planos";
$nonAdminTablesArr[] = "tb_planos_valores";
...
$wGroupTableName = $ug_connection->addTableWrappers( "seguranca_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "seguranca_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "seguranca_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "seguranca_ugrights" );

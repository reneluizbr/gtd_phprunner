...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="proc_limpar_tarefas_de_lista" && $field=="SomenteComDataConclusao")
	{
		return 1;
				...
				if($table=="proc_limpar_tarefas_de_lista" && $field=="SomenteSemComentarios")
	{
		return 1;
	}
				if($table=="proc_limpar_tarefas_de_lista" && $field=="lista_id")
	{
		return $_SESSION['par_lista_id'];
	}
				if($table=="tb_parametros" && $field=="para_ativo")
	{
		return "SIM";
	}
	return "";

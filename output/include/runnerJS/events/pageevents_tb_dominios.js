...
// Rene: converte a entrada de um campo sempre em maiusculas
var ctrl1 = Runner.getControl(pageid, 'domi_grupo');
ctrl1.addStyle('text-transform: uppercase;');

var ctrl2 = Runner.getControl(pageid, 'domi_valor');
ctrl2.addStyle('text-transform: uppercase;');
;
});

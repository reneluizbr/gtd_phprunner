 ...
 */
 ...
 class eventclass_tb_rotulos  extends eventsBase
{
...
$wl_tb_categorias_x_atividades = $dal->Table("tb_tarefas_x_rotulos");
...
$rs = DB::Query("select * from tb_tarefas_x_rotulos where cate_id = " . $deleted_values["cate_id"]);
$data=$rs->fetchAssoc();
if($data)
{

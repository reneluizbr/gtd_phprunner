...
$custom_labels["English"] = array();
	$custom_labels["English"]['TASKS'] = "Tasks";
			$custom_labels["English"]['TB_ATIVIDADE_DESCRIPTION'] = "Registering your Activities or Tasks in your routine";
			$custom_labels["English"]['TB_CLIENTES_DESCRIPTION'] = "Customer Registration";
			$custom_labels["English"]['TB_CLIENTES_PLANOS_DESCRIPTION'] = "Registration of Customer Plans that have the chosen benefits option";
			$custom_labels["English"]['TB_DOMINIOS_DESCRIPTION'] = "Registration of Domains that serve to assemble the list of system options";
			$custom_labels["English"]['TB_LISTA_ATIVIDADES_DESCRIPTION'] = "Register of Activities List that group activities that are associated with the same subject";
			$custom_labels["English"]['CUSTOM'] = "Registration of Access Plans, which are the options available in the system to access the functionalities";
			$custom_labels["English"]['CUSTOM1'] = "Registration of Plan Values. Place where monthly values for functionality plans are recorded";
			$custom_labels["English"]['CUSTOM2'] = "Registering the Status of Activities, which are the situations, positioning, in which each activity is found. Can be seen with the Kanban view";
	...
	$custom_labels["English"]['carga_inicial_cliente_pais'] = "To_define";
			...
			$custom_labels["English"]['CATEGORIES'] = "Tags";
			...
			$custom_labels["English"]['CAT_'] = "Tags";
			...
			$custom_labels["English"]['MONITORAMENTO_DE_ACESSOS_DO_SISTEMA'] = "Monitoring of system accesses. Here are recorded all the important changes in the data as well as the accesses of the users";
			$custom_labels["English"]['EXIBE_UM_GR_FICO_DE_ATIVIDADES_POR_LISTA'] = "Displays a chart of Activities by List where you have a view of the distribution of data in a friendly way";
			$custom_labels["English"]['GRAICO'] = "Graphical view of Tasks by Status where you have a visualization of the distribution of data in a friendly way";
			$custom_labels["English"]['VIS_O_GR_FICA_DAS_TAREFAS_POR_STATUS_ONDE_SE_TEM_UMA_VISUALIZA__O_DA_DISTRIBUI__O_DOS_DADOS_DE_FORMA_AMIG_VEL_'] = "Graphical view of Tasks by Priority where you have a visualization of the distribution of data in a friendly way";
			$custom_labels["English"]['E'] = "Graphical view of Tasks by User where you have a visualization of the distribution of data in a friendly way";
			$custom_labels["English"]['DASHSBOARD_QUE_CONT_M_UMA_P_GINA_AGRUPADORA_DAS_LISTAS_E_SUAS_TAREFAS_ASSOCIADAS_'] = "Dashboard containing a grouping page with various graphics of your tasks";
		...
		$custom_labels["English"]['P_GINAS_E_M_DULOS_ACESSADOS_FREQUENTEMENTE'] = "Páginas e módulos acessados frequentemente";
			$custom_labels["English"]['CATEGORIAS_POR_ATIVIDADES'] = "Tasks's Tags";
			$custom_labels["English"]['R_TULOS'] = "Tags";
			$custom_labels["English"]['R_TULOS1'] = "Tags";
			$custom_labels["English"]['R_TULOS2'] = "Tags, Labels";
			$custom_labels["English"]['STATUS_DE_TAREFAS1'] = "Tasks's Status";
			$custom_labels["English"]['VW_TAREFAS_ROTULOS'] = "VW Tags for Tasks";
			$custom_labels["English"]['VIEW_CRIADA_PARA_TESTES____N_O_DEVE_SER_UTILIZADA_'] = "(en) View criada para testes... Não deve ser utilizada.";
			$custom_labels["English"]['VW_TAREFAS_ROTULOS1'] = "Vw Tags for Tasks";
			$custom_labels["English"]['CADASTRO_DE_CATEGORIAS_OU_TAMB_M_CONHECIDA_COMO_R_TULOS_OU_ETIQUETAS____UMA_FORMA_N_O_R_GIDA_DE_AGRUPAMENTO_DE_TAREFAS_'] = "Registering Categories or also known as labels or tags, is a non-rigid form of grouping tasks";
			$custom_labels["English"]['ASSOCIA__O_ENTRE_AS_TAREFAS_E_SUAS_POSS_VEIS_CATEGORIZA__ES_OU_R_TULOS__ETIQUETAS__'] = "Association between Tasks and their possible categorizations or labels (tags)";
			$custom_labels["English"]['DASHSBOARD_QUE_CONT_M_UMA_P_GINA_AGRUPADORA_DAS_LISTAS_E_SUAS_TAREFAS_ASSOCIADAS_1'] = "Dashsboard that contains a grouping page of the Lists and their associated tasks";
			$custom_labels["English"]['PAR_METROS_E_CONFIGURA__ES_DO_SISTEMA_QUE_ORIENTAM_A_FORMA_DO_MESMO_FUNCIONAR_'] = "System parameters and settings that guide how it works";
			$custom_labels["English"]['P_GINAS_DO_SISTEMA'] = "System Pages";
			$custom_labels["English"]['P_GINAS_DO_SISTEMA_COM_CONFIGURA__ES_E_PARAMETROS'] = "System Pages with Settings and Parameters";
			$custom_labels["English"]['DEMAIS_P_GINAS'] = "Other pages";
			$custom_labels["English"]['CONSULTAS_E_GR_FICOS'] = "Queries and Charts";
			$custom_labels["English"]['DASHBOARDS__PAIN_LS_DE_OPERA__O_E_GR_FICOS'] = "Dashboards, Painéls de Operação e Gráficos";
			$custom_labels["English"]['DEMAIS_P_GINAS_DO_SISTEMA'] = "Other system pages";
			$custom_labels["English"]['OCORR_NCIAS_DE_TAREFAS'] = "Task Notes";
			$custom_labels["English"]['REGISTRO_DE_OCORR_NCIAS__APONTAMENTOS_DIVERSOS_OU_MESMO_NOTAS_PARA_DE_UMA_TAREFA'] = "Record of Notes, Miscellaneous Notes or even Occurrences for a task";
			$custom_labels["English"]['NOTAS'] = "Notes";
	...
	$custom_labels["Portuguese(Brazil)"]['carga_inicial_cliente_pais'] = "A_definir";
			...
			$custom_labels["Portuguese(Brazil)"]['CATEGORIES'] = "Rótulos";
			...
			$custom_labels["Portuguese(Brazil)"]['CAT_'] = "Rótulos";
		...
		$custom_labels["Portuguese(Brazil)"]['ROTINA_DI_RIA'] = "Rotina Diária";
			...
			$custom_labels["Portuguese(Brazil)"]['CATEGORIAS_POR_ATIVIDADES'] = "";
			$custom_labels["Portuguese(Brazil)"]['R_TULOS'] = "";
			$custom_labels["Portuguese(Brazil)"]['R_TULOS1'] = "Rótulos";
			$custom_labels["Portuguese(Brazil)"]['R_TULOS2'] = "Rótulos, Etiquetas";
			$custom_labels["Portuguese(Brazil)"]['STATUS_DE_TAREFAS1'] = "Status de Tarefas";
			$custom_labels["Portuguese(Brazil)"]['VW_TAREFAS_ROTULOS'] = "VW Tarefas Rotulos";
			$custom_labels["Portuguese(Brazil)"]['VIEW_CRIADA_PARA_TESTES____N_O_DEVE_SER_UTILIZADA_'] = "View criada para testes... Não deve ser utilizada.";
			$custom_labels["Portuguese(Brazil)"]['VW_TAREFAS_ROTULOS1'] = "Vw Tarefas Rotulos";
			$custom_labels["Portuguese(Brazil)"]['CADASTRO_DE_CATEGORIAS_OU_TAMB_M_CONHECIDA_COMO_R_TULOS_OU_ETIQUETAS____UMA_FORMA_N_O_R_GIDA_DE_AGRUPAMENTO_DE_TAREFAS_'] = "Cadastro de Categorias ou também conhecida como rótulos ou etiquetas, é uma forma não rígida de agrupamento de tarefas";
			$custom_labels["Portuguese(Brazil)"]['ASSOCIA__O_ENTRE_AS_TAREFAS_E_SUAS_POSS_VEIS_CATEGORIZA__ES_OU_R_TULOS__ETIQUETAS__'] = "Associação entre as Tarefas e suas possíveis categorizações ou rótulos (etiquetas)";
			$custom_labels["Portuguese(Brazil)"]['DASHSBOARD_QUE_CONT_M_UMA_P_GINA_AGRUPADORA_DAS_LISTAS_E_SUAS_TAREFAS_ASSOCIADAS_1'] = "Dashsboard que contém uma página agrupadora das Listas e suas tarefas associadas";
			$custom_labels["Portuguese(Brazil)"]['PAR_METROS_E_CONFIGURA__ES_DO_SISTEMA_QUE_ORIENTAM_A_FORMA_DO_MESMO_FUNCIONAR_'] = "Parâmetros e configurações do sistema que orientam a forma do mesmo funcionar";
			$custom_labels["Portuguese(Brazil)"]['P_GINAS_DO_SISTEMA'] = "Páginas do Sistema";
			$custom_labels["Portuguese(Brazil)"]['P_GINAS_DO_SISTEMA_COM_CONFIGURA__ES_E_PARAMETROS'] = "Páginas do Sistema com Configurações e Parametros";
			$custom_labels["Portuguese(Brazil)"]['DEMAIS_P_GINAS'] = "Demais páginas";
			$custom_labels["Portuguese(Brazil)"]['CONSULTAS_E_GR_FICOS'] = "Consultas e Gráficos";
			$custom_labels["Portuguese(Brazil)"]['DASHBOARDS__PAIN_LS_DE_OPERA__O_E_GR_FICOS'] = "Dashboards, Painéls de Operação e Gráficos";
			$custom_labels["Portuguese(Brazil)"]['DEMAIS_P_GINAS_DO_SISTEMA'] = "Demais páginas do sistema";
			$custom_labels["Portuguese(Brazil)"]['OCORR_NCIAS_DE_TAREFAS'] = "Ocorrências de Tarefas";
			$custom_labels["Portuguese(Brazil)"]['REGISTRO_DE_OCORR_NCIAS__APONTAMENTOS_DIVERSOS_OU_MESMO_NOTAS_PARA_DE_UMA_TAREFA'] = "Registro de Ocorrências, Apontamentos diversos ou mesmo Notas para de uma tarefa";
			$custom_labels["Portuguese(Brazil)"]['NOTAS'] = "Notas";
	$custom_labels["Spanish"] = array();
			$custom_labels["Spanish"]['TASKS'] = "Actividades";
			$custom_labels["Spanish"]['TB_ATIVIDADE_DESCRIPTION'] = "Registrando sus Actividades o Tareas en su rutina";
			$custom_labels["Spanish"]['TB_CLIENTES_DESCRIPTION'] = "Registro de cliente";
			$custom_labels["Spanish"]['TB_CLIENTES_PLANOS_DESCRIPTION'] = "Registro de Planes de Cliente que tienen la opción de beneficios elegida";
			$custom_labels["Spanish"]['TB_DOMINIOS_DESCRIPTION'] = "Registro de Dominios que sirven para armar la lista de opciones del sistema";
			$custom_labels["Spanish"]['TB_LISTA_ATIVIDADES_DESCRIPTION'] = "Registro de actividades Lista que agrupa las actividades que están asociadas a la misma asignatura";
			$custom_labels["Spanish"]['CUSTOM'] = "Registro de Planes de Acceso, que son las opciones disponibles en el sistema para acceder a las funcionalidades";
			$custom_labels["Spanish"]['CUSTOM1'] = "Registro de valores del plan. Lugar donde se registran los valores mensuales de los planes de funcionalidad";
			$custom_labels["Spanish"]['CUSTOM2'] = "Registro de Estado de Actividad que son las situaciones, posicionamiento, donde se encuentra cada actividad. Se puede ver con la vista Kanban";
	...
	$custom_labels["Spanish"]['carga_inicial_cliente_pais'] = "(es) A definir";
			...
			$custom_labels["Spanish"]['CATEGORIES'] = "(es) Rótulos";
			...
			$custom_labels["Spanish"]['CAT_'] = "Rótulos";
			...
			$custom_labels["Spanish"]['MONITORAMENTO_DE_ACESSOS_DO_SISTEMA'] = "Seguimiento de accesos al sistema. Aquí se registran todos los cambios importantes en los datos así como los accesos de los usuarios";
			$custom_labels["Spanish"]['EXIBE_UM_GR_FICO_DE_ATIVIDADES_POR_LISTA'] = "Muestra un gráfico de Actividades por Lista donde tiene una vista de la distribución de datos de una manera amigable";
			$custom_labels["Spanish"]['GRAICO'] = "Vista gráfica de Tareas por Estado donde tienes una visualización de la distribución de datos de forma amigable";
			$custom_labels["Spanish"]['VIS_O_GR_FICA_DAS_TAREFAS_POR_STATUS_ONDE_SE_TEM_UMA_VISUALIZA__O_DA_DISTRIBUI__O_DOS_DADOS_DE_FORMA_AMIG_VEL_'] = "Vista gráfica de Tareas por Prioridad donde tienes una visualización de la distribución de datos de forma amigable";
			$custom_labels["Spanish"]['E'] = "Vista gráfica de Tareas por Usuario donde tienes una visualización de la distribución de datos de forma amigable";
			$custom_labels["Spanish"]['DASHSBOARD_QUE_CONT_M_UMA_P_GINA_AGRUPADORA_DAS_LISTAS_E_SUAS_TAREFAS_ASSOCIADAS_'] = "Panel que contiene una página de agrupación con varios gráficos de sus tareas";
			...
			$custom_labels["Spanish"]['CATEGORIAS_POR_ATIVIDADES'] = "(es) Rótulos por Atividades";
			$custom_labels["Spanish"]['R_TULOS'] = "(es) Rótulos";
			$custom_labels["Spanish"]['R_TULOS1'] = "Rótulos";
			$custom_labels["Spanish"]['R_TULOS2'] = "Rótulos, Etiquetas";
			$custom_labels["Spanish"]['STATUS_DE_TAREFAS1'] = "Status de Tarefas";
			$custom_labels["Spanish"]['VW_TAREFAS_ROTULOS'] = "(es) vw Tarefas Rotulos";
			$custom_labels["Spanish"]['VIEW_CRIADA_PARA_TESTES____N_O_DEVE_SER_UTILIZADA_'] = "(es) View criada para testes... Não deve ser utilizada.";
			$custom_labels["Spanish"]['VW_TAREFAS_ROTULOS1'] = "(es) Vw Tarefas Rotulos";
			$custom_labels["Spanish"]['CADASTRO_DE_CATEGORIAS_OU_TAMB_M_CONHECIDA_COMO_R_TULOS_OU_ETIQUETAS____UMA_FORMA_N_O_R_GIDA_DE_AGRUPAMENTO_DE_TAREFAS_'] = "El registro de categorías o también conocido como etiquetas o etiquetas, es una forma no rígida de agrupación de tareas";
			$custom_labels["Spanish"]['ASSOCIA__O_ENTRE_AS_TAREFAS_E_SUAS_POSS_VEIS_CATEGORIZA__ES_OU_R_TULOS__ETIQUETAS__'] = "Asociación entre Tareas y sus posibles categorizaciones o etiquetas (etiquetas)";
			$custom_labels["Spanish"]['DASHSBOARD_QUE_CONT_M_UMA_P_GINA_AGRUPADORA_DAS_LISTAS_E_SUAS_TAREFAS_ASSOCIADAS_1'] = "Tablero que contiene una página de agrupación de las Listas y sus tareas asociadas";
			$custom_labels["Spanish"]['PAR_METROS_E_CONFIGURA__ES_DO_SISTEMA_QUE_ORIENTAM_A_FORMA_DO_MESMO_FUNCIONAR_'] = "Parámetros y configuraciones del sistema que guían su funcionamiento";
			$custom_labels["Spanish"]['P_GINAS_DO_SISTEMA'] = "Páginas del sistema";
			$custom_labels["Spanish"]['P_GINAS_DO_SISTEMA_COM_CONFIGURA__ES_E_PARAMETROS'] = "Páginas del sistema con configuraciones y parámetros";
			$custom_labels["Spanish"]['DEMAIS_P_GINAS'] = "Otras paginas";
			$custom_labels["Spanish"]['CONSULTAS_E_GR_FICOS'] = "Consultas y gráficos";
			$custom_labels["Spanish"]['DASHBOARDS__PAIN_LS_DE_OPERA__O_E_GR_FICOS'] = "Dashboards, Painéls de Operação e Gráficos";
			$custom_labels["Spanish"]['DEMAIS_P_GINAS_DO_SISTEMA'] = "Otras páginas del sistema";
			$custom_labels["Spanish"]['OCORR_NCIAS_DE_TAREFAS'] = "Notas de la tarea";
			$custom_labels["Spanish"]['REGISTRO_DE_OCORR_NCIAS__APONTAMENTOS_DIVERSOS_OU_MESMO_NOTAS_PARA_DE_UMA_TAREFA'] = "Registro de ocurrencias, notas varias o incluso notas para una tarea";
			$custom_labels["Spanish"]['NOTAS'] = "Nota";
...
$projectBuildKey = "1183_1616876864";
$wizardBuildKey = "33793";
$projectBuildNumber = "1183";
...
$tableCaptions["English"]["tb_rotulos"] = "Categories";
$tableCaptions["English"]["tb_tarefas_x_rotulos"] = "Tags for Tasks";
$tableCaptions["English"]["vw_dominio_tempo"] = "Vw Dominio Tempo";
$tableCaptions["English"]["vw_dominio_prioridade"] = "Vw Dominio Prioridade";
$tableCaptions["English"]["vw_tarefas_rotulos"] = "Vw Tarefas Rotulos";
...
$tableCaptions["English"]["tb_tarefas_ocorrencias"] = "Tb Tarefas Ocorrencias";
...
$tableCaptions["Portuguese(Brazil)"]["tb_rotulos"] = "Categorias";
$tableCaptions["Portuguese(Brazil)"]["tb_tarefas_x_rotulos"] = "Rótulos de Tarefas";
$tableCaptions["Portuguese(Brazil)"]["vw_dominio_tempo"] = "Vw Dominio Tempo";
$tableCaptions["Portuguese(Brazil)"]["vw_dominio_prioridade"] = "Vw Dominio Prioridade";
$tableCaptions["Portuguese(Brazil)"]["vw_tarefas_rotulos"] = "Vw Tarefas Rotulos";
...
$tableCaptions["Portuguese(Brazil)"]["tb_tarefas_ocorrencias"] = "Tb Tarefas Ocorrencias";
...
$tableCaptions["Spanish"]["tb_rotulos"] = "Categorias";
$tableCaptions["Spanish"]["tb_tarefas_x_rotulos"] = "Rótulos de Tarefas";
$tableCaptions["Spanish"]["vw_dominio_tempo"] = "Vw Dominio Tempo";
$tableCaptions["Spanish"]["vw_dominio_prioridade"] = "Vw Dominio Prioridade";
$tableCaptions["Spanish"]["vw_tarefas_rotulos"] = "Vw Tarefas Rotulos";
...
$tableCaptions["Spanish"]["tb_tarefas_ocorrencias"] = "Tb Tarefas Ocorrencias";

...
$custom_labels["English"] = array();
	$custom_labels["English"]['TASKS'] = "Activities";
	...
	$custom_labels["English"]['VERSAO_SISTEMA'] = "GTDTasks © - Build 2021.02.19 (en)";
	...
	$custom_labels["English"]['VERSAO_SISTEMA03'] = "GTD Build 2020.07.26 (en)";
		...
		$custom_labels["Portuguese(Brazil)"]['TASKS'] = "Atividades";
			...
			$custom_labels["Portuguese(Brazil)"]['TB_DOMINIOS_DESCRIPTION'] = "Cadastramento de Domínios";
			$custom_labels["Portuguese(Brazil)"]['TB_LISTA_ATIVIDADES_DESCRIPTION'] = "Cadastramento de Lista de Atividades";
			$custom_labels["Portuguese(Brazil)"]['CUSTOM'] = "Cadastramento de Planos de Acesso";
			$custom_labels["Portuguese(Brazil)"]['CUSTOM1'] = "Cadastramento de Valores de Planos";
	...
	$custom_labels["Portuguese(Brazil)"]['VERSAO_SISTEMA'] = "GTDTasks © - Build 2021.02.19 (pt)";
	...
	$custom_labels["Portuguese(Brazil)"]['VERSAO_SISTEMA03'] = "";
	...
	$custom_labels["Spanish"]['VERSAO_SISTEMA'] = "GTDTasks © - Build 2021.02.19 (es)";
	...
	$custom_labels["Spanish"]['VERSAO_SISTEMA03'] = "";
...
$tableCaptions["English"]["tb_lista_atividades"] = "Activities list";
$tableCaptions["English"]["tb_planos"] = "Access Plans";
$tableCaptions["English"]["tb_planos_valores"] = "Plan Values";
...
$tableCaptions["Portuguese(Brazil)"]["tb_lista_atividades"] = "Lista de Atividades";
...
$tableCaptions["Portuguese(Brazil)"]["log_audit"] = "Log Audit";
...
$tableCaptions["Spanish"]["tb_lista_atividades"] = "Lista de actividades";

...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_members["English"]["inclu_dt"] = "Included in";
	...
	$fieldLabelsadmin_members["English"]["inclu_login"] = "Inclu Login";
	$fieldToolTipsadmin_members["English"]["inclu_login"] = "";
	$placeHoldersadmin_members["English"]["inclu_login"] = "";
	$fieldLabelsadmin_members["English"]["alter_login"] = "Alter Login";
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["clie_id"] = "ID do Cliente";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["clie_id"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["clie_id"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["usua_domi_status"] = "Domi Status";
	...
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["inclu_login"] = "Inclu Login";
	$fieldToolTipsadmin_members["Portuguese(Brazil)"]["inclu_login"] = "";
	$placeHoldersadmin_members["Portuguese(Brazil)"]["inclu_login"] = "";
	$fieldLabelsadmin_members["Portuguese(Brazil)"]["alter_login"] = "Alter Login";
...
$tdataadmin_members[".sqlHead"] = "SELECT usua_id,  	clie_id,  	usua_domi_status,  	usua_email,  	usua_username,  	usua_senha,  	usua_login_ulti,  	inclu_login,  	inclu_dt,  	alter_login,  	alter_dt";

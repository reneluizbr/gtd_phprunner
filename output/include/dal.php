...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("tb_usuarios");
}
...
class tDAL
{
	...
	var $tblgtd_20200511_db3__tb_lista_atividades;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "tb_lista_atividades", "varname" => "gtd_20200511_db3__tb_lista_atividades", "altvarname" => "tb_lista_atividades", "connId" => "gtd_20200511_db3", "schema" => "", "connName" => "gtd_20200511.db3");
